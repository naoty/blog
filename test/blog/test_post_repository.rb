...
module Blog
  class TestPostRepository < Minitest::Test
    ...
    def test_find_post
      ...
      post = Post.new(id: 1, title: '', description: nil, time: Time.new(2020, 1, 1), tags: [], og_image_url: nil, body: '')
    ...
    def test_all_posts_sorted_by_time
      ...
      posts = [
        Post.new(id: 1, title: '', description: nil, time: Time.new(2020, 1, 1), tags: [], og_image_url: nil, body: ''),
        Post.new(id: 2, title: '', description: nil, time: Time.new(2020, 1, 2), tags: [], og_image_url: nil, body: '')
      ]
